...
class Codenames(object):
    ...
    def _load_document_frequencies(self):
        ...
        """
        if (os.path.exists("data/word_to_df")) and (os.path.exists("data/ptwiki-50M")):
            with open('data/word_to_df', 'rb') as f:
                word_to_df = pickle.load(f)
                num_docs = 801182
            
        else:
            dataset = open('data/ptwiki-50M')
...
if __name__ == "__main__":
    ...
    words = ['africa', 'oleo', 'abelha', 'agua', 'opera', 'aguia', 'orgao', 'acre', 'india', 'abobora', 'acordo', 'adulto', 'advogado', 'agente', 'agulha', 'alemanha', 'alfabeto', 'algodao', 'alienigena', 'alma', 'alpes', 'alvo', 'america', 'amazonas', 'ambulancia', 'brasilia', 'anao', 'anel', 'anjo', 'ar', 'antartida', 'aprendiz', 'aranha', 'arco', 'astro', 'aviao', 'bau', 'bacia', 'balao', 'bala', 'banco', 'banda', 'bar', 'barco', 'barra', 'arquivo', 'assinatura', 'atlantida', 'australia', 'biblia', 'bufalo', 'balanco', 'baleia', 'banana', 'banheiro', 'bateria', 'batida', 'pequim', 'berlim', 'bermuda', 'bloco', 'boca', 'bola', 'bolo', 'bordao', 'bolsa', 'bomba', 'botao', 'bota', 'braco', 'brilhante', 'brinco', 'broto', 'bruxa', 'buraco', 'circulo', 'codigo', 'colera', 'cabeca', 'cabo', 'cacho', 'cafe', 'caixa', 'calca', 'calha', 'cama', 'cachorro', 'cadeira', 'caminhao', 'caminho', 'campo', 'canada', 'canguru', 'cano', 'campo', 'capa', 'capital', 'capuz', 'cara', 'carga', 'caro', 'carro', 'cartao', 'casca', 'casco', 'cauda', 'cassino', 'cavaleiro', 'cavalo', 'cedo', 'cela', 'cenoura', 'centauro', 'centro', 'cerca', 'chave', 'chiclete', 'chifre', 'china', 'chocolate', 'churrasco', 'chuveiro', 'cientista', 'cinto', 'clube', 'cobertura', 'cobre', 'coelho', 'cola', 'colher', 'coluna', 'composto', 'comprimido', 'concerto', 'conexao', 'conta', 'conto', 'contrato', 'coracao', 'coral', 'coroa', 'corpo', 'correio', 'corrente', 'corte', 'costa', 'credito', 'cravo', 'cruz', 'cupim', 'cura', 'dado', 'dente', 'arranhaceu', 'dia', 'diafragma', 'diamante', 'dinossauro', 'direita', 'direito', 'divisao', 'doce', 'doutor', 'dragao', 'edificio', 'egito', 'embaixada', 'encontro', 'enfermeira', 'escala', 'escola', 'escorpiao', 'espaco', 'espiao', 'espinha', 'esquerda', 'estadio', 'estado', 'estrela', 'europa', 'fe', 'fosforo', 'faca', 'falcao', 'fantasma', 'fechadura', 'ferradura', 'ferro', 'ficha', 'figura', 'fila', 'filme', 'fita', 'flauta', 'floresta', 'fluxo', 'fogo', 'folha', 'fonte', 'forca', 'franca', 'frio', 'furo', 'gas', 'gemeos', 'genio', 'galo', 'gancho', 'garfo', 'garoto', 'garrafa', 'gato', 'gelo', 'germe', 'gigante', 'elefante', 'gota', 'grecia', 'cigano', 'grade', 'grama', 'grau', 'gravata', 'guerra', 'guia', 'heroi', 'helicoptero', 'himalaia', 'hortela', 'hospital', 'hotel', 'ilha', 'igreja', 'inglaterra', 'inscricao', 'jupiter', 'jogo', 'justa', 'laco', 'lingua', 'laboratorio', 'ladrao', 'lama', 'lance', 'laranja', 'lava', 'leao', 'lavadora', 'leito', 'lesma', 'leste', 'libra', 'liga', 'limao', 'lima', 'limusine', 'linha', 'lixa', 'loja', 'londres', 'lua', 'lutador', 'luva', 'luz', 'maquina', 'marmore', 'mao', 'mes', 'midia', 'maca', 'missao', 'macaco', 'magia', 'mal', 'mamute', 'manga', 'janeiro', 'marca', 'marcha', 'marfim', 'massa', 'mato', 'mastro', 'medida', 'meia', 'meio', 'mel', 'mercurio', 'milionario', 'carta', 'mexico', 'microscopio', 'mina', 'mochila', 'modelo', 'mole', 'morcego', 'morro', 'morte', 'moscou', 'muda', 'mudanca', 'mula', 'negativo', 'neve', 'ninja', 'noite', 'nota', 'recife', 'novela', 'olho', 'olimpo', 'onda', 'ordem', 'ouro', 'paraquedas', 'passaro', 'patio', 'pe', 'po', 'polo', 'pacifico', 'palha', 'panela', 'papel', 'parada', 'parede', 'parque', 'radio', 'partida', 'passado', 'passo', 'pata', 'porca', 'pauta', 'peao', 'peca', 'pedra', 'peixe', 'penhasco', 'peru', 'piano', 'piloto', 'pimenta', 'pincel', 'pinguim', 'pino', 'pistola', 'pirata', 'piso', 'piramide', 'pirata', 'pistola', 'plastico', 'plano', 'planta', 'poder', 'policia', 'politica', 'polegar', 'polvo', 'ponte', 'ponto', 'pinta', 'porto', 'posto', 'praia', 'prato', 'presente', 'presunto', 'primavera', 'princesa', 'professor', 'programa', 'prova', 'quadra', 'quadrado', 'quadro', 'quarto', 'feira', 'rainha', 'raio', 'raiz', 'ramo', 'rascunho', 'rato', 'real', 'recreio', 'rede', 'rei', 'relogio', 'revolucao', 'rio', 'robo', 'maquina', 'roda', 'rodada', 'roleta', 'rolo', 'roma', 'rosa', 'rosca', 'russo', 'sapato', 'satelite', 'saturno', 'sede', 'sela', 'selo', 'sentenca', 'servidor', 'sexta', 'sino', 'sola', 'soldado', 'som', 'sombra', 'sonho', 'sorte', 'sorvete', 'tenis', 'toquio', 'tanque', 'teatro', 'teia', 'tela', 'telescopio', 'templo', 'tempo', 'terno', 'terra', 'tiro', 'tocha', 'toco', 'tomada', 'torre', 'torta', 'trama', 'trave', 'trem', 'triangulo', 'trilha', 'tronco', 'tubarao', 'tubo', 'unha', 'unicornio', 'urso', 'vacuo', 'vara', 'vaso', 'vela', 'veneno', 'vento', 'verao', 'verde', 'verme', 'vestido', 'viagem', 'vida', 'vidro', 'volante', 'volta', 'dedo', 'sal', 'sol', 'violao', 'canela', 'troco', 'brigadeiro', 'registro', 'corda', 'mancha', 'pelo', 'fio', 'circuito', 'elemento', 'seda', 'cera']
    ...
    with open(amt_file_path, 'w', newline='') as csvfile:
        ...
        header_row = ['embedding_name', 'clue'] + ["word" + str(x) for x in range(0,10)]
    ...
    with open(amt_key_file_path, 'w', newline='') as csvfile:
        writer = csv.writer(csvfile, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        header_row = ['embedding_name', 'configuration','clue', 'word0ForClue', 'word1ForClue'] + ["blueWord" + str(x) for x in range(0,10)] + ["redWord" + str(x) for x in range(0,20)]
        writer.writerow(header_row)
    ...
    for embedding_type in shuffled_embeddings:
        ...
        for i, (red, blue) in enumerate(zip(red_words, blue_words)):
            ...
            for clues, board_words in zip( best_clues, best_board_words_for_clue):
                examples = open('examples.csv', 'a')
                #print()
                #print("Clue(s):", ", ".join(clues), "|| Intended board words:", board_words, "|| Score:", str(round(score,3)))
                print(board_words[0]+" "+board_words[1]+","+clues[0], file = examples)
